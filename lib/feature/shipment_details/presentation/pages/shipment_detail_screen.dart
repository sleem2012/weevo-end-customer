...
import 'package:weevo_end_customer/core/utlis/endpoints.dart';
                              ...
                              child: SizedBox(
                                ...
                                child: e.entity!.courier!.photo !=
                                    ...
                                    e.entity!.courier!.photo!
                                        .isNotEmpty
                                    ? FancyShimmerImage(
                                    imageUrl:e.entity!.courier!.photo!
                                        ,
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                // Row(children: [
                                //   productProvider.getCatById(data
                                //       .shipmentById
                                //       .products[0]
                                //       .productInfo
                                //       .categoryId) !=
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${double.parse(
                                      e.entity!.products![0].productInfo!
                                          .weight!).toInt()}',
                                  maxLines: 1,
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            const Text(
                                              ...
                                              //         data
                                              //             .shipmentById
                                              //             .receivingState))} - ${shipmentProvider
                                              //     .getCityNameById(
                                              //     int.parse(
                                              //         data
                                              //             .shipmentById
